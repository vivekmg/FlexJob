...
<head>
	...
	<?php require_once('header.php');
		...
		$row = jobselections($_COOKIE["uid"],3);
											...
											<div class="wt-userlistingcontent wt-userlistingcontentvtwo">
												<div class="wt-contenthead">
													...
													<ul class="wt-saveitem-breadcrumb wt-userlisting-breadcrumb">
															...
															<li><span class="wt-dashboradclock">Status:Cancel</span></li>	
													</ul>
												</div>
												<div class="wt-rightarea">
													<div class="wt-btnarea">
														<a href="bidacction.php?repost=<?php echo $result["jid"];?>" class="wt-btn">Repost</a>
														<a href="bidacction.php?delete=<?php echo $result["jid"];?>" class="wt-cancelbtn">Delete</a>
													</div>
												</div>
											</div>	
										</div>																			
