...
<head>
	...
	$row = jobselections($_COOKIE["uid"],0);
	?>
												...
												<div class="wt-userlistingcontent">
													...
													<div class="wt-rightarea">
														<!-- <div class="wt-hireduserstatus">
															<?php //$count = totalproposal($result["jid"]);
															//$total=mysqli_fetch_array($count);?>
															<h4><?php //echo $total[0]; ?></h4><span>Proposals</span>
														</div> -->
														<div class="wt-hireduserstatus">	
															<a href="companysidejobsingle.php?jid=<?php echo $result["jid"];?>"  class="wt-btn">VIEW DETAILS</a>
															<!-- <a href="companysidejobsingle.php?jid=<?php //echo $result["jid"];?>&pro=<?php //echo $total[0]?>"  class="wt-btn">VIEW DETAILS</a> -->
														</div>
													</div>
												</div>	
											</div>	
